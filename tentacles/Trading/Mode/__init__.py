...
# Custom trading mode - no version check needed
try:
    from .external_signal_trading_mode import *
except Exception as e:
    get_logger('TentacleLoader').error(f'Error when loading external_signal_trading_mode: '
