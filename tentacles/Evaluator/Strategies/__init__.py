...
# Custom strategy evaluator - no version check needed
try:
    from .external_signal_strategy_evaluator import *
except Exception as e:
    get_logger('TentacleLoader').error(f'Error when loading external_signal_strategy_evaluator: '
